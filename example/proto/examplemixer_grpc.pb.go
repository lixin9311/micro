...
func (c *greeterClient) Hello(ctx context.Context, in *HelloReq, opts ...grpc.CallOption) (*HelloResp, error) {
	out := new(HelloResp)
...
func (UnimplementedGreeterServer) Hello(context.Context, *HelloReq) (*HelloResp, error) {
